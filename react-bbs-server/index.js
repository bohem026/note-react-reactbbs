...
app.use('/uploads', express.static('uploads')); // /uploads 주소로 접속 시 폴더에 접근 권한 부여
...
const storage = multer.diskStorage({
  ...
  filename: function (req, file, cb) {
    ...
    const uniquePrefix = Date.now() + '-' + Math.round(Math.random() * /*1e9*/ 1000);
